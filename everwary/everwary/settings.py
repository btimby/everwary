...
if TESTING:
    DATABASES['default'] = {
        ...
        'TEST_NAME': os.path.join(tempfile.gettempdir(),
...
SECRET_KEY = 'jbfmlc1ny!&&m^+@91t9uea@_kh4cjz#fmun=_0-uwymmz6-yh'
...
ROOT_URLCONF = 'everwary.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'everwary.wsgi.application'
